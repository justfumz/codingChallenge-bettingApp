...
// field players. For Bayern Munich (team 1) create one variable ('gk') with
// the goalkeeper's name, and one array ('fieldPlayers') with all the remaining
// 10 field players
...
// with the number of goals that were scored in total
...
// /*
// //DESTRUCTURING
// const { players, score, scored, odds } = game;
...
// console.log(
//   team1 < team2 ? 'Team 1 is more likely to win' : 'Team 2 likely to win'
// );
...
// const { scored, odds, team1, team2 } = game;

// //1.
// const scorer = Object.entries(scored);
// console.log(scorer);
// for (const [key, value] of scorer) {
//   let num = Number(key) + 1;
//   console.log(`Goal ${num}: ${value} `);
// }
...
have a map with a log of the events that happened during the
 game. The values are the events themselves, and the keys are
  the minutes in which each event happened (a football game has 
...
3. Print the following string to the console: "An event
 happened, on average, every 9 minutes" (keep in mind that
